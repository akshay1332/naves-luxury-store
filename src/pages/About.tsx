  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 md:py-24">
        ...
        >
          <div>
            <h2 className="text-3xl font-serif mb-6">Heritage & Tradition</h2>
      ...
      {/* Values Section */}
      <section className="bg-secondary-dark py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-600">Dedicated to preserving traditional techniques while embracing modern innovation.</p>
            </div>
            <div className="text-center">
              <h3 className="text-2xl font-serif mb-4">Sustainability</h3>
              <p className="text-gray-600">Committed to ethical practices and environmental responsibility in fashion.</p>
            </div>
            <div className="text-center">
              <h3 className="text-2xl font-serif mb-4">Heritage</h3>
              <p className="text-gray-600">Celebrating cultural richness through timeless designs and authentic expression.</p>
            </div>
          </motion.div>
        </div>
      </section>
