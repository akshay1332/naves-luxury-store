...
const Carousel = memo(
  ({
    ...
    return (
      <div
        className="flex h-full items-center justify-center bg-luxury-pearl"
        style={{
          perspective: "1000px",
      ...
      >
        ...
        >
          {cards.map((imgUrl, i) => (
            <motion.div
              key={`key-${imgUrl}-${i}`}
              className="absolute flex h-full origin-center items-center justify-center rounded-xl bg-luxury-pearl p-2"
              style={{
                width: `${faceWidth}px`,
                transform: `rotateY(${
                  i * (360 / faceCount)
